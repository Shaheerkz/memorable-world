    ...
    <div class="row d-flex align-items-center justify-content-center pt-2 pb-2">
      ...
      <div class="col-md-10 col-sm-10">
        <div class="row align-items-center">
          <div class="col-xxl-7 col-lg-7 col-md-7 my-xl-0 my-3">
            <ul class="primary-navs">
              ...
              <div class="dropdown">
                <button onclick="window.location.href='./poets.php'" class="btn dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <div class="dropdown">
                <button onclick="window.location.href='./liabrary.php'" class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <div class="col-xl-5 col-lg-5 col-md-5 my-xl-0 my-3">
            <div class="btn-side d-flex justify-content-around align-items-center">
              ...
              <a href="#" class="btn pe-5 ps-5 py-2 mx-sm-3">Login</a>
              <a href="#" class="btn pe-5 ps-5 py-2 mx-sm-3">Register</a>
              <div class="menu-icon">
